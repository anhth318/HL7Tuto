...
public class OurOruR01MessageBuilder {
    ...
    */
    ...
    private void CreateObxSegment() throws DataTypeException, IOException {
        ...
        String base64EncodedStringOfPdfReport = _ourBase64Helper.ConvertToBase64String(new File("/Users/haianhtran/eclipse-workspace/HL7Tuto/TestHL7MessageFiles/ExtractedPathologyReport.pdf"));
